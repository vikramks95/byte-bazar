...
import { FiUsers, FiTrash2, FiSearch, FiArrowLeft } from 'react-icons/fi';
...
const AdminUsers = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      <Link to="/admin/dashboard" className="flex items-center gap-2 text-gray-500 hover:text-sky-500 mb-6 transition font-medium">
