  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-8">
        ...
        <Link to="/admin/users" className="flex items-center gap-2 bg-purple-600 text-white px-5 py-2.5 rounded-xl hover:bg-purple-700 transition font-semibold shadow-sm">
      ...
      {stats && (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          {[
            ...
            { label: 'Total Users', value: stats.totalUsers, icon: <FiUsers />, color: 'bg-purple-50 text-purple-600', link: '/admin/users' },
          ].map(s => {
            const cardContent = (
              <>
            ...
            return s.link ? (
              <Link key={s.label} to={s.link} className={`${s.color} rounded-2xl p-5 hover:shadow-md transition block`}>
                {cardContent}
              </Link>
            ) : (
