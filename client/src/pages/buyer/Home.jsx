...
const Home = () => {
  ...
  const handleStartSelling = (e) => {
    e.preventDefault();
    if (!user) {
      toast.info('Please register or log in as a Seller to start listing items!');
      navigate('/register');
      ...
      toast.warning('Your account is registered as a Buyer. To sell, please sign up or use a Seller account.');
      navigate('/profile');
    }
  };
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button onClick={handleStartSelling}
              className="border-2 border-white text-white font-bold px-8 py-3.5 rounded-xl hover:bg-white/10 transition flex items-center gap-2 justify-center cursor-pointer">
